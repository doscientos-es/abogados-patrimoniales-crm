    ...
    >
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Un único repositorio temporal para todo el despacho: lo que se registra aquí se ve en
            su contexto y en Fechas y plazos.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-5">
          ...
          <p className="-mt-2 text-xs text-muted-foreground">{DESCRIPCION[tipo]}</p>
          ...
          {tipo === "Recordatorio" ? (
            <div className="rounded-md border border-border bg-muted/30 p-3">
              <label className="flex items-center gap-2 text-sm">
                <Checkbox
                  checked={recurrente}
                  onCheckedChange={(v) => setRecurrente(Boolean(v))}
                />
            ...
            <div className="space-y-4 rounded-md border border-destructive/30 bg-destructive/5 p-3">
              ...
              {propuesta ? (
                <div className="rounded-md border border-warning/40 bg-warning/10 p-3">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">{propuesta.explicacion}</p>
                  <Button
                    type="button"
                    size="sm"
                    variant="outline"
