      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            <Label className="text-xs uppercase tracking-wide text-muted-foreground">Convertir en</Label>
          ...
          {duplicada ? (
            <p className="rounded-md border border-warning/40 bg-warning/10 px-3 py-2 text-sm text-warning-foreground">
              Ya existe una conversión activa de este tipo para esta nota. Revísala antes de crear otra.
            </p>
          ) : null}
