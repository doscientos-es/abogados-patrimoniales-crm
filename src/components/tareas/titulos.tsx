    ...
    <Card>
      ...
      <CardContent>
        <p className="mb-3 text-sm text-muted-foreground">
          Sugerencias de autocompletado al crear una tarea. El título siempre se puede escribir libre.
        </p>
        ...
        {titulos.length ? (
                ...
                {editando === t ? (
                  <>
                    ...
                    <span className="flex shrink-0 gap-1">
                      <Button size="icon" variant="ghost" className="h-8 w-8" onClick={() => guardar(t)}>
                  ...
                  <>
                    <span className="min-w-0 truncate text-sm text-foreground">{t}</span>
                    <span className="flex shrink-0 gap-1">
                      <Button
                        size="icon"
                        variant="ghost"
          ...
          <p className="text-sm text-muted-foreground">Todavía no hay títulos guardados.</p>
        )}
      </CardContent>
    </Card>
  );
