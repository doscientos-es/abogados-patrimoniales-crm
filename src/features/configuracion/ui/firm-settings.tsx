...
export function FirmSettings() {
  ...
  const [tab, setTab] = useState<'firm' | 'profile' | 'team'>('firm')
                ...
                <Field label="Correo profesional">
                  <div className="relative">
                    <Mail
                      ...
                      aria-hidden="true"
                    />
                    <Input className="bg-muted/40 pl-9" value={profileEmail} disabled readOnly />
                  </div>
                  <span className="text-muted-foreground block text-xs font-normal">
                    El correo lo gestiona el administrador del despacho.
                  </span>
                </Field>
