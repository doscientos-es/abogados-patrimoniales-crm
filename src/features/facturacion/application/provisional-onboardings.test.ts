...
const onboarding = (overrides = {}) =>
  ({
    id: 'onb-1',
    referencia: 'ONB-2026-00001',
    contactoId: 'contact-1',
    oportunidadId: null,
    expedienteId: null,
    asunto: 'Constitución societaria',
    fase: 'proforma',
    cambioFase: '2026-09-03',
    presupuestoReferencia: 'PR-2026-001',
    importePresupuesto: 2000,
    proformaEnviada: '2026-09-03',
    pagoConfirmado: null,
...
describe('resumenEconomicoProvisional', () => {
  ...
  it('uses clear labels without claiming a real invoice or collection', () => {
    ...
    expect(etiquetaEstadoEconomicoProvisional('payment_confirmed')).toBe(
