...
export const CUENTAS_CORREO: CuentaCorreo[] = [
  { id: "CU-INFO", direccion: "info@abogadospatrimoniales.es", nombre: "Buzón general", canal: "Email", tipo: "General", integracion: "Pendiente", activa: true },
  { id: "CU-ADM", direccion: "administracion@abogadospatrimoniales.es", nombre: "Administración", canal: "Email", tipo: "General", integracion: "Pendiente", activa: true },
  { id: "CU-JON", direccion: "jon@abogadospatrimoniales.es", nombre: "Buzón nominal", canal: "Email", tipo: "Nominal", integracion: "Pendiente", activa: true },
  { id: "CU-GODOY", direccion: "godoy@abogadospatrimoniales.es", nombre: "Buzón nominal", canal: "Email", tipo: "Nominal", integracion: "Pendiente", activa: true },
  { id: "CU-WA", direccion: "+34 944 029 988", nombre: "WhatsApp Business del despacho", canal: "WhatsApp", tipo: "General", integracion: "Pendiente", activa: true },
];

export const cuentaPorDireccion = (dir?: string) =>
  CUENTAS_CORREO.find((c) => c.direccion === dir);
...
export const cuentasDeUsuario = (usuario: string): string[] =>
  CUENTAS_POR_USUARIO[usuario] ?? [];
...
export const TAREAS_COMUNICACIONES_DEMO = [
  {
    ...
    origen: { tipo: "Comunicación" as const, id: "CM-9104", label: "Justificante de transferencia" },
    responsable: "Nuria Casals",
    colaboradores: [],
