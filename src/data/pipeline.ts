...
export function migrarFaseLegacy(
  ...
  switch (faseAntigua) {
    ...
    case "contratacion":
      ...
      if (subestado === "Sin respuesta")
        return { fase: "contratacion", subestado: "Sin respuesta" };
      if (
        [
      ...
      if (subestado === "Rechazado")
        return { fase: "cerrada", subestado: "Rechaza el presupuesto" };
      return { fase: "contratacion", subestado: "Pendiente de respuesta" };
    case "cualificacion":
...
export function alertasDe(o: OportunidadCRM, umbrales: Umbrales = UMBRALES_DEFECTO): string[] {
  ...
  if (o.fase !== "cerrada") {
    ...
    if (o.presupuestoEspejo.estado === "Requiere modificación")
      out.push("Rectificación solicitada");
