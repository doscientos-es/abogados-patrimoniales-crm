...
export function nombreCompleto(c: Pick<Contacto, "tipoPersona" | "nombre" | "apellidos" | "razonSocial">) {
...
function migrarContacto(c: ContactoRaw): Contacto {
  const relacion =
    c.relacion ??
    c.categorias.map((id) => RELACION_POR_CATEGORIA[id]).find(Boolean) ??
    "Tercero";
  ...
  if (categorias.length === 0) categorias.push(c.tipoPersona === "Persona física" ? "particular" : "empresa");
...
const CONTACTOS_BASE: ContactoRaw[] = [
  {
    ...
    historialSatisfaccion: [
      { fecha: "04/06/2026", nivel: "Muy alto", observacion: "Cierre del protocolo familiar.", autor: "A. Torregrosa" },
      { fecha: "18/01/2026", nivel: "Alto", observacion: "Buena valoración tras onboarding.", autor: "M. Sanchís" },
    ],
    recomendadoPor: {
      contactoId: "CT-0006",
  ...
  },
  {
    ...
    historialSatisfaccion: [
      { fecha: "10/05/2026", nivel: "Alto", observacion: "Reestructuración societaria satisfactoria.", autor: "A. Torregrosa" },
    ],
    recomendadoPor: {
      contactoId: "CT-0001",
    ...
    notas: [
      {
        ...
        contenido: "Pendiente de recibir las cuentas del ejercicio para revisar el reparto de dividendos.",
        autor: "L. Ferrer",
    ...
    notas: [
      {
        ...
        contenido: "Solicita presupuesto para la disolución de un proindiviso entre cuatro hermanos.",
        autor: "M. Sanchís",
  ...
  },
  {
    ...
    historialSatisfaccion: [
      { fecha: "20/03/2026", nivel: "Alto", observacion: "Colaboración fluida.", autor: "A. Torregrosa" },
    ],
    haRecomendado: [
      {
        contactoId: "CT-0008",
    ...
    proteccionDatos: [
      { tipo: "Consentimiento firmado", firma: "08/01/2024", estado: "Firmado", archivo: "RGPD_ARueda.pdf" },
    ],
    poderes: [
      {
        tipo: "Apud acta",
  ...
  },
  {
    ...
    historialSatisfaccion: [
      { fecha: "12/02/2026", nivel: "Muy alto", observacion: "Gran disponibilidad de agenda.", autor: "A. Torregrosa" },
    ],
    haRecomendado: [
      {
        contactoId: "CT-0001",
    ...
    proteccionDatos: [
      { tipo: "Cláusula informativa", firma: "03/03/2023", estado: "Firmado", archivo: "RGPD_Notaria.pdf" },
    ],
    poderes: [],
    otrosDocumentos: [
      {
  ...
  },
  {
    ...
    historialSatisfaccion: [
      { fecha: "05/04/2026", nivel: "Medio", observacion: "Retrasos puntuales en la remisión de actas.", autor: "L. Ferrer" },
    ],
    haRecomendado: [],
    incidencias: [
      {
  ...
  },
  {
    ...
    historialSatisfaccion: [
      { fecha: "28/05/2026", nivel: "Alto", observacion: "Informe entregado en plazo.", autor: "M. Sanchís" },
    ],
    recomendadoPor: {
      contactoId: "CT-0005",
    ...
    haRecomendado: [],
    incidencias: [],
    banco: { ...baseBanco, titular: "Peritaciones Delta, S.L.", nif: "B85002377", iban: "ES75 2085 8888 7703 3012 9911", entidad: "Ibercaja", bic: "CAZRES2ZXXX", estadoMandato: "Sin mandato" },
    documentacion: { identificacion: "Completa", rgpd: "Firmada", poderes: "Inexistentes" },
    identificacion: [
      { tipo: "Tarjeta CIF", numero: "B85002377", expedicion: "12/05/2018", estado: "Vigente", archivo: "CIF_Delta.pdf" },
    ],
    proteccionDatos: [
      { tipo: "Consentimiento firmado", firma: "11/04/2026", estado: "Firmado", archivo: "RGPD_Delta.pdf" },
    ],
    poderes: [],
    otrosDocumentos: [],
    notas: [],
  ...
  },
  {
    ...
    historialSatisfaccion: [
      { fecha: "02/06/2026", nivel: "Muy alto", observacion: "Excelente informe de plusvalías.", autor: "A. Torregrosa" },
    ],
    haRecomendado: [],
    incidencias: [],
    banco: { ...baseBanco, titular: "Marta Solé Ribas", nif: "38774120P", iban: "ES40 0081 0301 2200 0111 8877", entidad: "Banc Sabadell", bic: "BSABESBBXXX", estadoMandato: "Sin mandato" },
    documentacion: { identificacion: "Completa", rgpd: "Firmada", poderes: "Inexistentes" },
    identificacion: [
      { tipo: "DNI", numero: "38774120P", expedicion: "14/08/2016", caducidad: "14/08/2026", estado: "Próximo a caducar", archivo: "DNI_MSole.pdf" },
    ],
    proteccionDatos: [
      { tipo: "Consentimiento firmado", firma: "20/05/2023", estado: "Firmado", archivo: "RGPD_MSole.pdf" },
    ],
    poderes: [],
    otrosDocumentos: [],
    notas: [],
  ...
  },
  {
    ...
    historialSatisfaccion: [
      { fecha: "15/12/2025", nivel: "Bajo", observacion: "Disconforme con la duración del procedimiento.", autor: "A. Torregrosa" },
    ...
    banco: { ...baseBanco, titular: "Jorge Landa Etxeberria", nif: "16220487D", iban: "ES29 2095 0100 8091 2233 4455", entidad: "Kutxabank", bic: "BASKES2BXXX", estadoMandato: "Cancelado" },
    documentacion: { identificacion: "Caducada", rgpd: "Revocada", poderes: "Inexistentes" },
    identificacion: [
      { tipo: "DNI", numero: "16220487D", expedicion: "02/02/2015", caducidad: "02/02/2025", estado: "Caducado", archivo: "DNI_JLanda.pdf" },
    ],
    proteccionDatos: [
      { tipo: "Revocación del consentimiento", firma: "20/12/2025", estado: "Revocado", archivo: "RGPD_revocacion.pdf" },
    ],
    poderes: [],
    otrosDocumentos: [],
    notas: [],
  ...
  },
  {
    ...
    historialSatisfaccion: [
      { fecha: "30/09/2025", nivel: "Muy bajo", observacion: "Incumplimiento reiterado de plazos.", autor: "L. Ferrer" },
    ],
    haRecomendado: [],
    incidencias: [
      {
