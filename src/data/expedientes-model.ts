...
export const MEGAFASES: Megafase[] = [
  { id: "f1", codigo: "F1", nombre: "LEAD", descripcion: "Captación y oportunidad comercial (módulo CRM).", clase: "mf-f1" },
  { id: "f2", codigo: "F2", nombre: "ONBOARDING", descripcion: "Aceptación, presupuesto, contratación y apertura.", clase: "mf-f2" },
  { id: "f3", codigo: "F3", nombre: "CASEWORK", descripcion: "Trabajo técnico del expediente.", clase: "mf-f3" },
  { id: "f4", codigo: "F4", nombre: "DELIVERY", descripcion: "Entrega, propuesta y formalización.", clase: "mf-f4" },
  { id: "f5", codigo: "F5", nombre: "OFFBOARDING", descripcion: "Cierre del encargo y traspaso.", clase: "mf-f5" },
  { id: "f6", codigo: "F6", nombre: "AFTERCARE", descripcion: "Cumplimiento, seguimiento y archivo.", clase: "mf-f6" },
  {
    id: "especial",
    codigo: "—",
...
export const FASES_JUDICIAL: ColumnaKanban[] = [
  { id: "diagnostico", nombre: "Diagnóstico – Objetivos – Estrategia procesal", tono: "info", megafase: "f3" },
  { id: "revision", nombre: "Revisión y decisión", tono: "info", megafase: "f3" },
  { id: "preparacion", nombre: "Preparación y primeras actuaciones procesales", tono: "info", megafase: "f3" },
  ...
  { id: "firmeza", nombre: "Firmeza y actuaciones posteriores al resultado", tono: "info", megafase: "f4" },
  { id: "cierre-procedimiento", nombre: "Cierre del procedimiento / Traspaso", tono: "aviso", megafase: "f5" },
...
export const FASES_EXTRAJUDICIAL: ColumnaKanban[] = [
  { id: "diagnostico", nombre: "Diagnóstico – Objetivos – Estrategia", tono: "info", megafase: "f3" },
  { id: "revision", nombre: "Revisión y decisión", tono: "info", megafase: "f3" },
...
export type FuenteIA = {
  tipo: "Actuación" | "Documento" | "Tarea" | "Plazo" | "Comunicación" | "Nota" | "Línea" | "Expediente" | "Económico";
  id: string;
  label: string;
...
export const TONO_ESTADO_LINEA: Record<EstadoLinea, "neutro" | "info" | "aviso" | "exito" | "riesgo"> = {
  Pendiente: "neutro",
  "En análisis": "info",
  "En curso": "info",
  "En espera": "aviso",
...
export const COLUMNAS_DOC_ELABORADOS: ColumnaKanban[] = [
  ...
  { id: "Pendiente de presentación o entrega", nombre: "Listos para presentar o entregar", tono: "info" },
...
export const ETIQUETAS_INICIALES: EtiquetaTarea[] = [
  { id: "ET-COM", nombre: "Interés comercial", color: "turquesa", archivada: false, creadaEn: "01/01/2026", creadaPor: "Sistema" },
  { id: "ET-PER", nombre: "Personal", color: "gris", archivada: false, creadaEn: "01/01/2026", creadaPor: "Sistema" },
  { id: "ET-ADM", nombre: "Administración", color: "azul", archivada: false, creadaEn: "01/01/2026", creadaPor: "Sistema" },
  { id: "ET-GES", nombre: "Gestión del despacho", color: "verde", archivada: false, creadaEn: "01/01/2026", creadaPor: "Sistema" },
  { id: "ET-FAC", nombre: "Facturación / cobros", color: "ambar", archivada: false, creadaEn: "01/01/2026", creadaPor: "Sistema" },
  { id: "ET-INF", nombre: "Informática / sistemas", color: "morado", archivada: false, creadaEn: "01/01/2026", creadaPor: "Sistema" },
  { id: "ET-FOR", nombre: "Formación", color: "rosa", archivada: false, creadaEn: "01/01/2026", creadaPor: "Sistema" },
];
...
const versionesTrabajo = (autor: string, fecha: string): VersionDocumento[] => [
  { numero: 1, tipo: "Documento de trabajo", autor, fecha, comentarios: "Primer borrador", definitiva: false },
];
...
function semilla(): Semilla {
  ...
  const documentos: Documento[] = [
    ...
    },
    {
      ...
      version: 3,
      versiones: [
        { numero: 1, tipo: "Documento de trabajo", autor: "Luis Ferrán", fecha: "28/04/2026", comentarios: "Borrador inicial", definitiva: false },
        { numero: 2, tipo: "Versión revisada", autor: "Igor Belmonte", fecha: "05/05/2026", comentarios: "Revisión de fundamentos", definitiva: false },
        { numero: 3, tipo: "Versión presentada o entregada", autor: "Luis Ferrán", fecha: "09/05/2026", comentarios: "Presentada por LexNET", definitiva: true },
      ],
      confidencialidad: "Normal",
    ...
    },
    {
      ...
      version: 4,
      versiones: [
        { numero: 1, tipo: "Documento de trabajo", autor: "Ana Torregrosa", fecha: "20/05/2026", comentarios: "Primer borrador", definitiva: false },
        { numero: 2, tipo: "Versión revisada", autor: "Igor Belmonte", fecha: "28/05/2026", comentarios: "Ajuste de calendario de pagos", definitiva: false },
        { numero: 3, tipo: "Versión aprobada", autor: "Cliente", fecha: "05/06/2026", comentarios: "Conformidad del cliente", definitiva: false },
        { numero: 4, tipo: "Versión firmada", autor: "Partes", fecha: "12/06/2026", comentarios: "Firmado en reunión", definitiva: true },
      ],
    ...
    },
    {
      ...
      version: 2,
      versiones: [
        { numero: 1, tipo: "Documento de trabajo", autor: "Nuria Casals", fecha: d(-4), comentarios: "Borrador", definitiva: false },
        { numero: 2, tipo: "Versión revisada", autor: "Luis Ferrán", fecha: d(-1), comentarios: "Revisado, pendiente de firma", definitiva: false },
      ],
      confidencialidad: "Normal",
  ...
  const tareas: TareaOp[] = [
    ...
    },
    {
      ...
      historico: [
        { id: "HT-0001", fecha: d(-2), autor: "Ana Torregrosa", accion: "Creación", detalle: "Cadena de burofax generada desde plantilla." },
      ],
    },
    {
      id: "TR-0007",
  ...
  const fechas: FechaCritica[] = [
    ...
    /* ----- DEMO · registros temporales de prueba (borrables en bloque) ----- */
    {
      id: "FC-9001",
      expedienteId: "EX-0101",
      origen: { tipo: "Tarea", id: "TR-0001", label: "Validar el plazo de recurso de la sentencia" },
      tipo: "Recordatorio",
  ...
  const intervinientes: IntervinienteOp[] = [
    { id: "IN-0001", expedienteId: "EX-0101", contactoId: "CT-0011", nombre: nombreContacto("CT-0011"), rol: "Cliente", contacto: "cliente@correo.es", observaciones: "", confidencialidad: "Normal" },
    { id: "IN-0002", expedienteId: "EX-0101", nombre: "Rosa Ibáñez", rol: "Procurador", contacto: "rosa.ibanez@procuradores.es", observaciones: "Procuradora en Alicante", confidencialidad: "Normal" },
    { id: "IN-0003", expedienteId: "EX-0101", nombre: "Construcciones Bahía, S.L.", rol: "Contraparte", contacto: "—", observaciones: "", confidencialidad: "Normal" },
    { id: "IN-0004", expedienteId: "EX-0101", nombre: "Juzgado de Primera Instancia nº 4 de Alicante", rol: "Juzgado", contacto: "—", observaciones: "Autos 412/2026", confidencialidad: "Normal" },
    { id: "IN-0005", expedienteId: "EX-0102", contactoId: "CT-0003", nombre: nombreContacto("CT-0003"), rol: "Cliente", contacto: "—", observaciones: "", confidencialidad: "Normal" },
    { id: "IN-0006", expedienteId: "EX-0102", nombre: "Hermanos Sempere, C.B.", rol: "Contraparte", contacto: "—", observaciones: "", confidencialidad: "Restringida" },
    { id: "IN-0007", expedienteId: "EX-0103", contactoId: "CT-0007", nombre: nombreContacto("CT-0007"), rol: "Cliente", contacto: "—", observaciones: "", confidencialidad: "Normal" },
    { id: "IN-0008", expedienteId: "EX-0103", nombre: "Rosa Ibáñez", rol: "Procurador", contacto: "rosa.ibanez@procuradores.es", observaciones: "", confidencialidad: "Normal" },
    { id: "IN-0009", expedienteId: "EX-0104", contactoId: "CT-0002", nombre: nombreContacto("CT-0002"), rol: "Cliente", contacto: "—", observaciones: "", confidencialidad: "Normal" },
    { id: "IN-0010", expedienteId: "EX-0104", nombre: "Notaría Ruiz de Alda", rol: "Notaría", contacto: "notaria@ruizdealda.es", observaciones: "", confidencialidad: "Normal" },
    { id: "IN-0011", expedienteId: "EX-0105", contactoId: "CT-0007", nombre: nombreContacto("CT-0007"), rol: "Cliente", contacto: "—", observaciones: "", confidencialidad: "Normal" },
  ];

  const auditoria: AuditoriaItem[] = [
    { id: "AU-0001", fecha: `${d(-2)} 09:40`, usuario: "Nuria Casals", accion: "Alta de documento", entidad: "Documento", entidadId: "DOC-0001", expedienteId: "EX-0101", anterior: "—", nuevo: "Sentencia 231/2026" },
    { id: "AU-0002", fecha: `${d(-2)} 09:45`, usuario: "Sistema", accion: "Propuesta de plazo", entidad: "Fecha crítica", entidadId: "FC-0001", expedienteId: "EX-0101", anterior: "—", nuevo: "Posible plazo pendiente de validar" },
    { id: "AU-0003", fecha: `${HOY} 08:00`, usuario: "Sistema", accion: "Carga de datos de demostración", entidad: "Expediente", entidadId: "—", anterior: "—", nuevo: `${expedientes.length} expedientes` },
  ];

  const recordatorios: Recordatorio[] = [
    { id: "RC-0001", expedienteId: "EX-0101", lineaId: "LT-0011", fecha: d(3), hora: "09:00", texto: "Comprobar si el juzgado ha señalado fecha de lanzamiento", responsable: "Marta Solé", estado: "Pendiente", creadoPor: "Marta Solé", creadoEl: d(-2) },
    { id: "RC-0002", expedienteId: "EX-0101", lineaId: "LT-0012", fecha: d(-1), hora: "12:00", texto: "Llamar al perito para confirmar disponibilidad", responsable: "Nuria Casals", estado: "Pendiente", creadoPor: "Marta Solé", creadoEl: d(-6) },
    { id: "RC-0003", expedienteId: "EX-0101", lineaId: "LT-0013", fecha: d(-5), texto: "Revisar si el contrario ha contestado a la propuesta", responsable: "Marta Solé", estado: "Atendido", creadoPor: "Marta Solé", creadoEl: d(-12) },
  ];
