...
export const PERMISOS: { area: string; perfiles: Record<PerfilUsuario, "Total" | "Lectura" | "Sin acceso"> }[] = [
  {
...
export const ETAPAS_OPORTUNIDAD: {
  ...
  { id: "presupuesto-solicitado", nombre: "Presupuesto solicitado", grupo: "Presupuesto", tono: "aviso" },
  { id: "presupuesto-tramitacion", nombre: "Presupuesto en tramitación", grupo: "Presupuesto", tono: "aviso" },
  { id: "presupuesto-enviado", nombre: "Presupuesto enviado", grupo: "Presupuesto", tono: "info" },
  { id: "pendiente-aceptacion", nombre: "Pendiente de aceptación", grupo: "Presupuesto", tono: "aviso" },
  { id: "pendiente-proforma", nombre: "Aceptado, pendiente de proforma", grupo: "Presupuesto", tono: "info" },
  { id: "proforma-enviada", nombre: "Proforma enviada, pendiente de pago", grupo: "Presupuesto", tono: "aviso" },
  { id: "preparada-convertir", nombre: "Pagado, preparado para convertir", grupo: "Cierre", tono: "exito" },
...
export const etapaOportunidad = (id: EtapaOportunidadId) =>
  ...
  ({ id, nombre: String(id), grupo: "Captación", tono: "neutro" } as (typeof ETAPAS_OPORTUNIDAD)[number]);
...
export const OPORTUNIDADES: Oportunidad[] = [
  {
    ...
    intervinientes: [{ contactoId: "CT-0003", nombre: "Ramón Iglesias Peña", rol: "Potencial cliente" }],
    analisis: {
    ...
    notas: [{ fecha: "04/08/2026", autor: "Nuria Casals", texto: "Entra por formulario web a las 21:14." }],
    historial: [
      {
  ...
  },
  {
    ...
    intervinientes: [
      ...
      { contactoId: "CT-0002", nombre: "Inversiones Torrelodones, S.L.", rol: "Sociedad del grupo" },
    ...
    notas: [
      { fecha: "03/08/2026", autor: "Ana Torregrosa", texto: "Confirma asistencia también el hijo mayor." },
    ],
    historial: [
      { fecha: "01/08/2026 09:40", usuario: "Ana Torregrosa", tipo: "Creación", descripcion: "Oportunidad creada" },
      {
  ...
  },
  {
    ...
    intervinientes: [
      { contactoId: "CT-0007", nombre: "Gestión de Fincas Levante, S.L.U.", rol: "Potencial cliente" },
    ...
    historial: [
      { fecha: "28/07/2026 10:00", usuario: "Luis Ferrán", tipo: "Creación", descripcion: "Oportunidad creada" },
      {
  ...
  },
  {
    ...
    notas: [{ fecha: "02/08/2026", autor: "Marta Solé", texto: "Cliente pide desglose por fases." }],
    historial: [
      { fecha: "20/07/2026 11:30", usuario: "Marta Solé", tipo: "Creación", descripcion: "Oportunidad creada" },
      {
  ...
  },
  {
    ...
    descripcion: "Otorgamiento de testamento y planificación de la sucesión del patrimonio inmobiliario.",
    ...
    notas: [],
    historial: [
      { fecha: "15/07/2026 09:00", usuario: "Ana Torregrosa", tipo: "Creación", descripcion: "Oportunidad creada" },
      { fecha: "01/08/2026 10:20", usuario: "Igor Belmonte", tipo: "Validación", descripcion: "Presupuesto validado" },
      { fecha: "03/08/2026 12:00", usuario: "Nuria Casals", tipo: "Facturación", descripcion: "Proforma PF-2026-0011 enviada" },
    ],
  },
  {
    id: "OP-0006",
    ...
    descripcion: "Adquisición de local comercial con revisión registral, urbanística y arrendaticia.",
    ...
    notas: [{ fecha: "04/08/2026", autor: "Nuria Casals", texto: "Transferencia recibida por el total." }],
    historial: [
      { fecha: "10/07/2026 08:45", usuario: "Luis Ferrán", tipo: "Creación", descripcion: "Oportunidad creada" },
      { fecha: "28/07/2026 11:00", usuario: "Igor Belmonte", tipo: "Validación", descripcion: "Presupuesto validado" },
      { fecha: "01/08/2026 09:30", usuario: "Cliente", tipo: "Aceptación", descripcion: "Presupuesto aceptado por el cliente" },
      { fecha: "04/08/2026 10:10", usuario: "Nuria Casals", tipo: "Cobro", descripcion: "Pago íntegro recibido", proxima: "Abrir expediente" },
    ],
  },
  {
    id: "OP-0007",
    ...
    intervinientes: [{ contactoId: "CT-0011", nombre: "Jorge Landa Etxeberria", rol: "Potencial cliente" }],
    analisis: {
      viabilidad: "Alta",
      complejidad: "Baja",
      riesgos: "Ninguno",
    ...
    notas: [],
    historial: [
      { fecha: "05/07/2026 10:00", usuario: "Marta Solé", tipo: "Creación", descripcion: "Oportunidad creada" },
      { fecha: "22/07/2026 18:00", usuario: "Marta Solé", tipo: "Cierre", descripcion: "Cerrada por precio", resultado: "Perdida" },
    ],
  },
  {
    id: "OP-0008",
    ...
    situacionDocumental: "Pendiente",
    situacionPresupuesto: "Sin presupuesto",
    descripcion: "Acción de división de cosa común sobre finca proindiviso entre cuatro coherederos.",
    ...
    notas: [{ fecha: "30/07/2026", autor: "Ana Torregrosa", texto: "Elevar a comité el posible conflicto." }],
    historial: [
      { fecha: "30/07/2026 09:00", usuario: "Ana Torregrosa", tipo: "Creación", descripcion: "Oportunidad creada" },
      { fecha: "30/07/2026 12:00", usuario: "Ana Torregrosa", tipo: "Alerta", descripcion: "Posible conflicto de intereses" },
    ],
  },
  {
    id: "OP-0009",
    ...
    intervinientes: [{ contactoId: "CT-0007", nombre: "Gestión de Fincas Levante, S.L.U.", rol: "Potencial cliente" }],
    analisis: {
      viabilidad: "Alta",
      complejidad: "Baja",
    ...
    notas: [],
    historial: [
      { fecha: "18/07/2026 10:00", usuario: "Luis Ferrán", tipo: "Creación", descripcion: "Oportunidad creada" },
      { fecha: "29/07/2026 09:00", usuario: "Nuria Casals", tipo: "Presupuesto", descripcion: "Presupuesto enviado" },
    ],
  },
  {
    id: "OP-0010",
    ...
    notas: [],
    historial: [
      { fecha: "12/06/2026 12:00", usuario: "Ana Torregrosa", tipo: "Conversión", descripcion: "Convertida en expediente EX-2026-0002" },
    ],
  },
];
...
export const ESTADOS_PRESUPUESTO: {
  ...
  { id: "pendiente-validacion", nombre: "Pendiente de validación", grupo: "Validación", tono: "aviso" },
...
export const estadoPresupuesto = (id: EstadoPresupuestoId) =>
  ...
  ({ id, nombre: String(id), grupo: "Elaboración", tono: "neutro" } as (typeof ESTADOS_PRESUPUESTO)[number]);
...
export type Presupuesto = {
  ...
  fechaFase?: string;
  envio?: { fecha: string; destinatario: string; canal: string; caducidad: string; seguimiento?: string };
...
export const PRESUPUESTOS: Presupuesto[] = [
  {
    ...
    versiones: [
      ...
      { version: "v2", fecha: "26/05/2026", autor: "Luis Ferrán", cambio: "Se añade gestión registral" },
    ],
    validaciones: [
      { fecha: "27/05/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme" },
    ],
    proforma: { numero: "PF-2026-0004", fecha: "29/05/2026", importe: "2.700 €", estado: "Pagada", pagado: "100 %" },
    historial: [
      { fecha: "20/05/2026", usuario: "Ana Torregrosa", tipo: "Solicitud", descripcion: "Presupuesto solicitado" },
      { fecha: "27/05/2026", usuario: "Igor Belmonte", tipo: "Validación", descripcion: "Validado" },
      { fecha: "12/06/2026", usuario: "Nuria Casals", tipo: "Cobro", descripcion: "Pago total recibido" },
    ],
  },
  {
    id: "PR-0002",
    ...
    validado: false,
    versiones: [{ version: "v1", fecha: "05/08/2026", autor: "Luis Ferrán", cambio: "Versión inicial" }],
    validaciones: [],
    historial: [
      { fecha: "04/08/2026", usuario: "Luis Ferrán", tipo: "Solicitud", descripcion: "Presupuesto solicitado" },
      { fecha: "05/08/2026", usuario: "Luis Ferrán", tipo: "Estado", descripcion: "Enviado a validación de Igor" },
    ],
  },
  {
    id: "PR-0003",
    ...
    validaciones: [
      { fecha: "29/07/2026", validador: "Igor Belmonte", resultado: "Devuelto", observacion: "Falta desglose por fases" },
      { fecha: "01/08/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme tras rectificación" },
    ],
    historial: [
      { fecha: "01/08/2026", usuario: "Igor Belmonte", tipo: "Validación", descripcion: "Validado v2" },
      { fecha: "02/08/2026", usuario: "Nuria Casals", tipo: "Envío", descripcion: "Enviado al cliente", proxima: "Seguimiento 08/08" },
    ],
    envio: {
      fecha: "02/08/2026",
  ...
  },
  {
    ...
    observaciones: "—",
    validado: true,
    versiones: [{ version: "v1", fecha: "28/07/2026", autor: "Ana Torregrosa", cambio: "Versión inicial" }],
    validaciones: [{ fecha: "01/08/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme" }],
    proforma: { numero: "PF-2026-0011", fecha: "03/08/2026", importe: "1.900 €", estado: "Pendiente de pago", pagado: "0 %" },
    historial: [
      { fecha: "01/08/2026", usuario: "Igor Belmonte", tipo: "Validación", descripcion: "Validado" },
      { fecha: "03/08/2026", usuario: "Nuria Casals", tipo: "Proforma", descripcion: "Proforma PF-2026-0011 enviada" },
    ],
  ...
  },
  {
    ...
    validado: true,
    versiones: [{ version: "v1", fecha: "26/07/2026", autor: "Luis Ferrán", cambio: "Versión inicial" }],
    validaciones: [{ fecha: "28/07/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme" }],
    proforma: { numero: "PF-2026-0012", fecha: "01/08/2026", importe: "4.750 €", estado: "Pagada", pagado: "100 %" },
    historial: [
      { fecha: "28/07/2026", usuario: "Igor Belmonte", tipo: "Validación", descripcion: "Validado" },
      { fecha: "04/08/2026", usuario: "Nuria Casals", tipo: "Cobro", descripcion: "Pago recibido", proxima: "Abrir expediente" },
    ],
  },
  {
    id: "PR-0006",
    ...
    validaciones: [{ fecha: "28/07/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme" }],
    historial: [
      { fecha: "29/07/2026", usuario: "Nuria Casals", tipo: "Envío", descripcion: "Enviado al cliente" },
    ],
    envio: {
      fecha: "29/07/2026",
  ...
  },
  {
    ...
    validaciones: [
      { fecha: "04/08/2026", validador: "Igor Belmonte", resultado: "Devuelto", observacion: "Detallar actuaciones incluidas" },
    ],
    historial: [
      { fecha: "04/08/2026", usuario: "Igor Belmonte", tipo: "Validación", descripcion: "Devuelto para rectificación" },
    ],
  },
  {
    id: "PR-0008",
    ...
    validaciones: [],
    historial: [{ fecha: "03/08/2026", usuario: "Marta Solé", tipo: "Asignación", descripcion: "Asignado a Luis Ferrán" }],
  },
  {
    id: "PR-0009",
    codigo: "PR-2026-0009",
    ...
    validado: true,
    versiones: [{ version: "v1", fecha: "10/07/2026", autor: "Marta Solé", cambio: "Versión inicial" }],
    validaciones: [{ fecha: "12/07/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme" }],
    proforma: { numero: "PF-2026-0009", fecha: "15/07/2026", importe: "2.000 €", estado: "Pago parcial", pagado: "50 %" },
    historial: [{ fecha: "20/07/2026", usuario: "Nuria Casals", tipo: "Cobro", descripcion: "Primer plazo cobrado" }],
  },
  {
    id: "PR-0010",
    codigo: "PR-2026-0010",
    ...
    validado: true,
    versiones: [{ version: "v1", fecha: "12/07/2026", autor: "Marta Solé", cambio: "Versión inicial" }],
    validaciones: [{ fecha: "14/07/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme" }],
    historial: [{ fecha: "22/07/2026", usuario: "Marta Solé", tipo: "Respuesta", descripcion: "Rechazado por el cliente" }],
  },
  {
    id: "PR-0011",
    codigo: "PR-2026-0011",
    ...
    versiones: [],
    validaciones: [],
    historial: [{ fecha: "04/08/2026", usuario: "Ana Torregrosa", tipo: "Solicitud", descripcion: "Presupuesto solicitado" }],
  },
  {
    id: "PR-0012",
    codigo: "PR-2026-0012",
    ...
    validado: true,
    versiones: [{ version: "v1", fecha: "20/06/2026", autor: "Luis Ferrán", cambio: "Versión inicial" }],
    validaciones: [{ fecha: "22/06/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme" }],
    historial: [{ fecha: "20/07/2026", usuario: "Sistema", tipo: "Estado", descripcion: "Presupuesto caducado" }],
    cierre: { motivo: "Caducado", fecha: "20/07/2026", observacion: "Vigencia vencida sin respuesta." },
  ...
  },
  {
    ...
    validado: true,
    versiones: [{ version: "v1", fecha: "10/08/2026", autor: "Ana Torregrosa", cambio: "Versión inicial" }],
    validaciones: [{ fecha: "12/08/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme" }],
    historial: [
      { fecha: "10/08/2026", usuario: "Ana Torregrosa", tipo: "Estado", descripcion: "Enviado a validación" },
      { fecha: "12/08/2026", usuario: "Igor Belmonte", tipo: "Validación", descripcion: "Validado v1", proxima: "Enviar al cliente" },
    ],
  ...
  },
  {
    ...
    versiones: [
      ...
      { version: "v3", fecha: "13/08/2026", autor: "Marta Solé", cambio: "Nueva forma de pago (en preparación)" },
    ],
    validaciones: [{ fecha: "22/07/2026", validador: "Igor Belmonte", resultado: "Validado", observacion: "Conforme v1" }],
    historial: [
      { fecha: "24/07/2026", usuario: "Nuria Casals", tipo: "Envío", descripcion: "Enviado al cliente" },
      { fecha: "12/08/2026", usuario: "Marta Solé", tipo: "Respuesta", descripcion: "El cliente solicita cambios en la forma de pago" },
    ],
    envio: {
      fecha: "24/07/2026",
  ...
  },
  {
    ...
    validaciones: [],
    historial: [
      { fecha: "08/08/2026", usuario: "Ana Torregrosa", tipo: "Solicitud", descripcion: "Presupuesto solicitado" },
      { fecha: "11/08/2026", usuario: "Luis Ferrán", tipo: "Estado", descripcion: "Bloqueado: falta documentación registral" },
    ],
...
export const FASES_PRESUPUESTO: {
  ...
  { id: "preparacion", nombre: "Preparación", descripcion: "Solicitado, asignado, en elaboración o bloqueado.", tono: "info" },
  { id: "validacion", nombre: "Pendiente de validación", descripcion: "Remitido a Igor para su revisión.", tono: "aviso" },
  { id: "listo", nombre: "Listo para enviar", descripcion: "Validado y pendiente de remisión al cliente.", tono: "exito" },
  { id: "cliente", nombre: "Pendiente del cliente", descripcion: "Enviado y a la espera de respuesta.", tono: "info" },
  { id: "revision", nombre: "En revisión", descripcion: "Negociación o nueva versión en preparación.", tono: "aviso" },
  { id: "aceptado", nombre: "Aceptado", descripcion: "Encargo aceptado por el cliente.", tono: "exito" },
  { id: "cerrado", nombre: "Cerrado sin encargo", descripcion: "Rechazado, caducado o cancelado.", tono: "riesgo" },
];
...
export const situacionEconomica = (p: Presupuesto): { texto: string; tono: Tono } => {
  ...
  if (p.proforma.estado === "Pagada" || pagado === "100 %") return { texto: "Pagado", tono: "exito" };
...
export const etiquetasPresupuesto = (p: Presupuesto): { texto: string; tono: Tono }[] => {
  ...
  if (fase === "preparacion") {
    if (p.estado === "pendiente-info") out.push({ texto: "Pendiente de información", tono: "riesgo" });
    else if (p.estado === "devuelto") out.push({ texto: "Rectificación solicitada", tono: "riesgo" });
  ...
  if (fase === "cliente") {
    ...
    if (seg && seg.getTime() < HOY.getTime()) out.push({ texto: "Seguimiento vencido", tono: "riesgo" });
  }
  if (fase === "aceptado") {
...
export const siguienteAccionPresupuesto = (p: Presupuesto): string => {
  switch (faseDePresupuesto(p)) {
    ...
    case "aceptado":
      return p.proforma ? (situacionEconomica(p).texto === "Pagado" ? "Abrir expediente" : "Seguir el cobro") : "Generar proforma";
    case "cerrado":
...
export const FASES_EXPEDIENTE: { id: FaseExpedienteId; nombre: string; descripcion: string }[] = [
  { id: "onboarding", nombre: "Onboarding", descripcion: "Alta del encargo y documentación inicial" },
...
export type Expediente = {
  ...
  presupuestos: string[];
  cierre?: { entrega: string; conformidad: string; facturacion: string; cobro: string; archivo: string };
...
export const EXPEDIENTES: Expediente[] = [
  {
    ...
    actuaciones: [{ fecha: "05/08/2026", titulo: "Apertura del expediente", responsable: "Luis Ferrán", estado: "Completada" }],
    fechasCriticas: [{ fecha: "30/09/2026", titulo: "Fecha límite de escritura", tipo: "Contractual", estado: "Vigente" }],
    presupuestos: ["PR-0005"],
    historial: [
      { fecha: "05/08/2026", usuario: "Luis Ferrán", tipo: "Conversión", descripcion: "Expediente abierto desde OP-2026-0006" },
    ],
  },
  {
    id: "EX-0002",
    ...
    actuaciones: [
      { fecha: "20/06/2026", titulo: "Redacción de estatutos", responsable: "Luis Ferrán", estado: "Completada" },
      { fecha: "15/07/2026", titulo: "Firma en notaría", responsable: "Ana Torregrosa", estado: "Completada" },
      { fecha: "11/08/2026", titulo: "Presentación en el registro", responsable: "Nuria Casals", estado: "Prevista" },
    ],
    fechasCriticas: [{ fecha: "11/08/2026", titulo: "Presentación registral", tipo: "Administrativa", estado: "Vigente" }],
    presupuestos: ["PR-0001"],
    historial: [{ fecha: "12/06/2026", usuario: "Ana Torregrosa", tipo: "Conversión", descripcion: "Expediente abierto desde OP-2026-0010" }],
  },
  {
    id: "EX-0003",
    codigo: "EX-2026-0003",
    ...
    actuaciones: [
      { fecha: "12/04/2026", titulo: "Demanda presentada", responsable: "Marta Solé", estado: "Completada" },
      { fecha: "31/07/2026", titulo: "Proposición de prueba", responsable: "Marta Solé", estado: "Vencida" },
    ],
    fechasCriticas: [{ fecha: "31/07/2026", titulo: "Plazo de proposición de prueba", tipo: "Procesal", estado: "Vencida" }],
    presupuestos: ["PR-0007"],
    historial: [{ fecha: "31/07/2026", usuario: "Sistema", tipo: "Alerta", descripcion: "Actuación vencida" }],
  },
  {
    id: "EX-0004",
    codigo: "EX-2026-0004",
    ...
    actuaciones: [{ fecha: "20/07/2026", titulo: "Sentencia favorable notificada", responsable: "Luis Ferrán", estado: "Completada" }],
    fechasCriticas: [{ fecha: "15/08/2026", titulo: "Plazo para recurso de la contraria", tipo: "Procesal", estado: "Vigente" }],
    ...
    historial: [{ fecha: "20/07/2026", usuario: "Luis Ferrán", tipo: "Hito", descripcion: "Sentencia favorable" }],
  },
  {
    id: "EX-0005",
    codigo: "EX-2026-0005",
    ...
    actuaciones: [{ fecha: "10/07/2026", titulo: "Demanda ejecutiva presentada", responsable: "Marta Solé", estado: "Completada" }],
    fechasCriticas: [{ fecha: "20/08/2026", titulo: "Seguimiento de la ejecución", tipo: "Interna", estado: "Vigente" }],
    ...
    historial: [{ fecha: "10/07/2026", usuario: "Marta Solé", tipo: "Actuación", descripcion: "Demanda ejecutiva presentada" }],
  },
  {
    id: "EX-0006",
    codigo: "EX-2026-0006",
    ...
    intervinientes: [{ contactoId: "CT-0007", nombre: "Gestión de Fincas Levante, S.L.U.", rol: "Cliente" }],
    onboarding: [
      { paso: "Identificación del cliente", estado: "Completado" },
      { paso: "Comprobación de conflicto de intereses", estado: "Completado" },
      { paso: "Hoja de encargo", estado: "Completado" },
    ...
    actuaciones: [{ fecha: "20/06/2026", titulo: "Informe anual entregado", responsable: "Luis Ferrán", estado: "Completada" }],
    fechasCriticas: [{ fecha: "15/09/2026", titulo: "Revisión anual", tipo: "Interna", estado: "Vigente" }],
    ...
    historial: [{ fecha: "20/06/2026", usuario: "Luis Ferrán", tipo: "Entrega", descripcion: "Informe anual entregado" }],
  },
];
...
export type Relacion = { tipo: "Contacto" | "Oportunidad" | "Presupuesto" | "Expediente"; id: string; label: string };
...
export const EVENTOS: EventoCalendario[] = [
  { id: "EV-1", fecha: "05/08/2026", hora: "12:00", titulo: "Llamada de cualificación", categoria: "Actividad", responsable: "Nuria Casals", relacion: "OP-2026-0001" },
  { id: "EV-2", fecha: "05/08/2026", hora: "18:00", titulo: "Reunión interna de conflicto", categoria: "Actividad", responsable: "Igor Belmonte", relacion: "OP-2026-0008" },
  { id: "EV-3", fecha: "06/08/2026", hora: "11:00", titulo: "Solicitud documental", categoria: "Actividad", responsable: "Luis Ferrán", relacion: "OP-2026-0003" },
  { id: "EV-4", fecha: "06/08/2026", titulo: "Validar PR-2026-0002", categoria: "Tarea", responsable: "Igor Belmonte", relacion: "PR-2026-0002" },
  { id: "EV-5", fecha: "07/08/2026", titulo: "Firma de hoja de encargo", categoria: "Tarea", responsable: "Luis Ferrán", relacion: "EX-2026-0001" },
  { id: "EV-6", fecha: "08/08/2026", hora: "09:30", titulo: "Seguimiento de presupuesto", categoria: "Seguimiento", responsable: "Marta Solé", relacion: "PR-2026-0003" },
  { id: "EV-7", fecha: "10/08/2026", hora: "10:30", titulo: "Primera cita — Elena Vargas", categoria: "Cita", responsable: "Ana Torregrosa", relacion: "OP-2026-0002" },
  { id: "EV-8", fecha: "11/08/2026", titulo: "Presentación registral", categoria: "Fecha crítica", responsable: "Nuria Casals", relacion: "EX-2026-0002" },
  { id: "EV-9", fecha: "15/08/2026", titulo: "Plazo de recurso de la contraria", categoria: "Fecha crítica", responsable: "Luis Ferrán", relacion: "EX-2026-0004" },
  { id: "EV-10", fecha: "20/08/2026", titulo: "Seguimiento de la ejecución", categoria: "Fecha crítica", responsable: "Marta Solé", relacion: "EX-2026-0005" },
  { id: "EV-11", fecha: "24/08/2026", hora: "17:00", titulo: "Reunión de seguimiento con cliente", categoria: "Cita", responsable: "Ana Torregrosa", relacion: "EX-2026-0002" },
  { id: "EV-12", fecha: "31/07/2026", titulo: "Proposición de prueba (vencida)", categoria: "Fecha crítica", responsable: "Marta Solé", relacion: "EX-2026-0003" },
];
