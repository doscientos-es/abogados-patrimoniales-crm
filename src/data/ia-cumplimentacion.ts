...
const CAMPOS_CONTACTO: CampoEsquema[] = [
  {
    id: 'naturaleza',
    label: 'Naturaleza',
    ayuda: 'Persona física / Persona jurídica / Órgano judicial / Público',
  },
...
const CAMPOS_EXPEDIENTE: CampoEsquema[] = [
  {
    id: 'denominacion',
    label: 'Denominación provisional del expediente',
    ayuda: 'Propuesta a partir de las partes; requiere validación',
  },
...
const CAMPOS_INTERVINIENTE: CampoEsquema[] = [
  ...
  {
    id: 'rolExpediente',
    label: 'Interviene como',
    ayuda: 'Rol dentro de este expediente; no modifica la ficha del contacto',
  },
...
export const ESQUEMAS: Record<FormularioIA, EsquemaFormulario> = {
  ...
  interviniente: {
    id: 'interviniente',
    titulo: 'Nuevo interviniente',
    campos: CAMPOS_INTERVINIENTE,
    admitePersonas: true,
  },
  profesional: {
    id: 'profesional',
    titulo: 'Alta de profesional',
    campos: CAMPOS_PROFESIONAL,
    admitePersonas: true,
  },
}
