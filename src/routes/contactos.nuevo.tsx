        ...
        <Card>
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Campo label="Naturaleza">
              ...
              {errores.naturaleza ? (
                <p className="text-xs text-destructive">Selecciona una naturaleza.</p>
              ) : null}
            </Campo>
            <Campo label="Relación con el despacho">
              ...
              {errores.relacion ? (
                <p className="text-xs text-destructive">
                  Selecciona la relación con el despacho.
                </p>
              ) : null}
            </Campo>
...
function BorradoresNotas({
  ...
  return (
    <div className="flex flex-wrap gap-4">
      ...
      <div className="w-full max-w-xs rotate-1 rounded-sm border border-postit-border bg-postit p-4 text-postit-foreground shadow-md">
        <Input
          value={titulo}
          onChange={(e) => setTitulo(e.target.value)}
          placeholder="Título de la nota (opcional)"
          className="mb-2 h-8 border-0 border-b border-postit-border/70 bg-transparent px-0 font-serif text-base font-semibold text-postit-foreground shadow-none placeholder:text-postit-foreground/60 focus-visible:ring-0"
        />
        <Textarea
          rows={5}
          value={contenido}
          ...
          className="resize-none border-0 bg-transparent px-0 text-sm text-postit-foreground shadow-none placeholder:text-postit-foreground/60 focus-visible:ring-0"
        />
        <label className="mt-2 flex items-center gap-2 text-xs text-postit-foreground/80">
          <Checkbox
            checked={destacada}
        ...
        <label className="mt-1 flex items-center gap-2 text-xs text-postit-foreground/80">
          <Checkbox
            checked={critica}
